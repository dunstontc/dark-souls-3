export default [
    ...
    `,
    "location": `
      Rank 2 covenant reward: Watchdogs of Farron.
      +1 Version (NG+) Can be found on a corpse immediately outside the Keep Ruins bonfire building.
      +2 Version (NG++): Can be found in Cemetery of Ash, after the Iudex Gundyr boss fight. Its lying behind the golden door, on the left.
      +3 Version (The Ringed City): Dropped by Seeker of the Spurned.
    `,
    "image": "5044",
	},
	{
